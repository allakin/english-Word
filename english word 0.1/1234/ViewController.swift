...
class ViewController: UIViewController {
  ...
  var words: [String] = [
    ...
    "admiring - Восхищающийся -ing (TR!)",
    "admission - допуск, вход, прием",
    "admit - допускать",
    "admittance - впуск, доступ a-ce",
    "admitted - Признанный(допущенный) (TR!)",
    ...
    "advanced - передовой",
    "advancing - Продвижение -ing (TR!)",
    "advantage - преимущество, выгода",
    "advantages - Преимущества (TR!)",
    ...
    "affectionately - Нежно (TR!)",
    "affections - Привязанности (TR!)",
    "affirmative - утвердительный",
    "afford - позволить себе",
    "afforded - Предоставляемый *f- (TR!)",
    "affray - пугать",
    "afore - перед",
    "afraid - испуганный",
    "afresh - снова, опять",
    ...
    "aggregated - Соединенный (TR!)",
    "aggregation - Скопление (TR!)",
    "agitated - Взволнованный *g- (не thrilled) (TR!)",
    "agitation - агитация",
    ...
    "altered - Измененный (не changed) (TR!)",
    ...
    "applications - Заявления(применения) (TR!)",
    "applied - прикладной",
    "apply - обращаться, применять",
    "appointed - Назначенный (TR!)",
    ...
    "assemble - созывать",
    "assembled - Собранный (TR!)",
    "assembly - собрание, ассамблея",
    "asserted - Утвержденный (не attested) (TR!)",
    "asset - имущество",
    "assign - назначать",
    "assigned - Назначенный (TR!)",
    ...
    "assumed - Принятый (не adopted) (TR!)",
    ...
    "astonishing - Удивительный -ing (TR!)",
    ...
    "axis - ось",
    "ay - Да (TR!)",
    "aye - Утвердительный ответ, положительный ответ (не yes) (TR!)",
    "bab - Бэб (TR!)",
    "babble - бормотание, болтовня b-",
    "baby - ребенок",
    "back - спина, назад",
    "backed - Поддержанный (TR!)",
    "background - фон, задний план",
    "backs - Задние части b- (TR!)",
    "backup - Резервный *a- (TR!)",
    ...
    "beamed - Сиял (TR!)",
    "beaming - Сияющий (от слова beam) (TR!)",
    "beams - Лучи (TR!)",
    "bean - боб",
    "beans - фасоль",
    ...
    "bearing - Отношение(поведение) -ing (TR!)",
    "bears - Медведи (TR!)",
    ...
    "best - наилучший",
    "bestowed - Подаренный (TR!)",
    "bet - держать пари, пари",
    "beth - Бет (TR!)",
    "betray - предавать",
    "betrayed - Преданный (от слова предательство) (TR!)",
    "better - лучше",
    "betty - Бетти (TR!)",
    "between - между",
    "beverley - Беверлей (TR!)",
    ...
    "billy - Билли (TR!)",
    "bin - бункер !NEW!",
    "binary - Набор из двух предметов (TR!)",
    ...
    "blazing - Сверкание -ing (TR!)",
    "bleach - белить (ткань)",
    "bleeding - Кровотечение (TR!)",
    ...
    "blobs - Капли (не drops) (TR!)",
    "block - блок, квартал",
    "blockade - блокада",
    "blocked - Блокированный (TR!)",
    ...
    "boring - скучный",
    "born - рожденный",
    "borne - ограниченный, с узким кругозором, узколобый, закостенелый (TR!)",
    "borrow - брать в долг",
    ...
    "candidate - кандидат",
    "candle - свеча",
    "candling - Миражирование -ing (TR!)",
    "cane - трость, палка",
    "canes - Тростники(трости) (TR!)",
    ...
    "captured - Захваченный (TR!)",
    "car - машина",
    "caravan - фургон",
    "carbon - углерод",
    "carbonate - Карбонат (TR!)",
    "card - карточка",
    "cardboard - картон",
    ...
    "connect - соединять",
    "connecting - Соединение -ing (TR!)",
    "connection - соединение",
    "connections - Связи (TR!)",
    "conquer - завоевывать, завоевать",
    "conquered - Побежденный (TR!)",
    ...
    "consent - разрешение",
    "consented - Соглашался (TR!)",
    "consequence - следствие, вывод, значение",
    "consequences - Последствия (TR!)",
    ...
    "considering - Рассмотрение -ing (TR!)",
    "consist - состоять",
    "consisted - Состоял (TR!)",
    ...
    "constraint - Ограничение (TR!)",
    "constraints - Ограничения (TR!)",
    ...
    "containing - Содержащий (TR!)",
    "contains - Содержит (TR!)",
    "contemporary - современный",
    "contempt - презрение (не aversion)",
    "contend - бороться, соперничать *o-",
    "content - содержание",
    "contented - Удовлетворенный (не satisfied) (TR!)",
    ...
    "converted - Преобразованный(конвертированный) (TR!)",
    "convey - перевозить, передавать, сообщать",
    "conveyed - Переданный (TR!)",
    ...
    "defined - Определенный (TR!)",
    "definite - определенный, точный",
    "definitely - Определенно (TR!)",
    ...
    "derived - Полученный (TR!)",
    "des - Дес (TR!)",
    "descend - спускаться",
    "descendant - потомок",
    "descended - Спускался (TR!)",
    ...
    "directed - Направленный (TR!)",
    "direction - направление",
    "directions - Руководства(направления) (TR!)",
    ...
    "disappearing - Исчезновение -ing (TR!)",
    ...
    "distract - отвлекать",
    "distracted - Отвлеченный (TR!)",
    "distress - горе, нужда; огорчать, расстраивать d-",
    "distressed - Обеспокоенный (TR!)",
    ...
    "dock - док, пристань",
    "doctor - доктор, врач",
    "doctrine - Доктрина (TR!)",
    "document - документ",
    "documentation - Документация (TR!)",
    ...
    "doubloons - Дублоны (TR!)",
    "doubly - вдвое",
    "doubt - сомнение, сомневаться",
    "doubted - Подвергнутый сомнению (TR!)",
    ...
    "earl - граф !NEW!",
    "earlier - Ранее (TR!)",
    "earliest - Самый ранний (TR!)",
    "early - рано",
    "earn - зарабатывать",
    "earnest - серьезный e-",
    "earnestly - Искренне (не sincerely) (TR!)",
    "earnestness - Серьезность (не seriousness) (TR!)",
    "earth - земля",
    "earthquake - землетрясение",
    "ease - покой, непринужденность e-",
    "easel - мольберт",
    "easier - Более легкий (TR!)",
    "easily - легко",
    ...
    "effected - Произведенный (не produced) *f- (TR!)",
    "effective - действующий, успешный",
    "effects - Эффекты (TR!)",
    "effectually - Целесообразно (TR!)",
    ...
    "elements - Элементы (TR!)",
    "elephant - слон",
    "elevate - поднимать, возвышать",
    "elevated - Поднятый (TR!)",
    "elevation - Возвышение (TR!)",
    "elevator - лифт",
    "eleven - одиннадцать",
    "elf - Эльф (TR!)",
    ...
    "elinor - Элеонор (TR!)",
    "eliza - Элиза (TR!)",
    "elizabeth - Элизабет (TR!)",
    "elliot - Эллиот (TR!)",
    "eloise - Элоиза (TR!)",
    "elongated - Удлиненный (TR!)",
    "else - еще, кроме",
    "elsewhere - В другом месте (TR!)",
    "elton - Эльтон (TR!)",
    "embark - садиться на корабль",
    "embarrass - смущать",
    "embarrassment - Затруднение (TR!)",
    "embedded - Вложенный (TR!)",
    ...
    "enhanced - Увеличенный (TR!)",
    "enhancements - Повышения (TR!)",
    ...
    "enough - достаточный",
    "enquired - Спрашивал e- (TR!)",
    "enslave - порабощать",
    "ensued - Последовал (TR!)",
    ...
    "ere - До, перед, прежде чем; скорее чем (TR!)",
    "erect - строить (не build)",
    "ernest - Эрнест (TR!)",
    "ernie - Ерни (TR!)",
    "err - Допустить ошибку (TR!)",
    "errand - поручение",
    ...
    "exhibited - Показанный (не displayed) (TR!)",
    "exhibition - выставка",
    "exist - существовать, жить",
    "existence - существование",
    "existing - Существующий -ing (TR!)",
    "exists - Существует (TR!)",
    "exit - выход, выезд",
    "expanded - Расширенный (не extended) (TR!)",
    ...
    "exposed - Выставленный(подвергнутый) (TR!)",
    "exposure - Подвергание (TR!)",
    ...
    "extended - растянутый",
    "extending - Распространение(продление) (TR!)",
    ...
    "fashion - мода",
    "fashionable - модный",
    "fashioned - Вылепленный (TR!)",
    "fast - спешащий, сильно, быстро (fast)",
    "fasten - прикреплять f-",
    "fastened - Закрепленный (не attached) (TR!)",
    "faster - быстрее",
    "fat - жирный",
    "fatal - фатальный",
    "fate - судьба",
    ...
    "faults - Ошибки f- (TR!)",
    "favor - Польза(покровительство) (TR!)",
    ...
    "features - Особенности (TR!)",
    "February - февраль",
    "fed - Кормивший(питаемый) (TR!)",
    ...
    "feral - Дикий (не от слова wild) (TR!)",
    "ferment - закваска, фермент; бродить (о вине, варенье)",
    "ferocious - дикий",
    "ferocity - свирепость",
    "ferry - перевоз f-",
    "fertile - плодородный",
    "fertilised - Оплодотворенный (TR!)",
    "fertility - Изобилие (не abundance) (TR!)",
    ...
    "figure - фигура",
    "figured - Изображенный (TR!)",
    "filament - Нить (TR!)",
    "filch - Украсть (не steal) (TR!)",
    "file - картотека",
    "files - Файлы (TR!)",
    ...
    "fire - огонь, пожар",
    "fireplace - Камин (TR!)",
    "fires - Огни(пожары) (TR!)",
    "firewood - дрова",
    "fireworks - фейерверк",
    "firing - Увольнение(обстрел) -ing (TR!)",
    ...
    "fortunes - Благосостояния (не welfares) (TR!)",
    "forty - сорок",
    ...
    "gain - прибыль",
    "gained - Полученный (TR!)",
    "galactic - Галактический (TR!)",
    "galaxy - Галактика (TR!)",
    "gale - шторм",
    ...
    "generations - Поколения (TR!)",
    "generator - Генератор (TR!)",
    ...
    "geological - Геологический (TR!)",
    "geology - геология",
    "geometry - геометрия",
    "georgiana - Георгиана (TR!)",
    ...
    "glad - рад",
    "gladly - С удовольствием (TR!)",
    "glance - взглянуть, мелькнуть",
    "glanced - Поглядел (TR!)",
    "glancing - Глядящий -ing (TR!)",
    "gland - железа",
    "glands - Гланды (TR!)",
    "glare - сверкать",
    "glass - стакан, бокал",
    ...
    "grew - рос (от grow)",
    "grey - серый",
    "gride - Скрип (не creak) (TR!)",
    "grief - горе",
    "grieved - Огорченный (TR!)",
    "grievously - горестно",
    "grill - решетка",
    ...
    "header - Удар головой (TR!)",
    "heading - заголовок",
    "headless - Безголовый (TR!)",
    "headlight - фара (автомобиля), огни (паровоза)",
    "headline - заголовок",
    "headlong - очертя голову",
    "headmaster - Директор школы (TR!)",
    "headphones - наушники",
    "headquarters - штаб",
    "heads - головы (от head)",
    "headstone - Надгробный камень (TR!)",
    "heal - излечивать",
    "health - здоровье",
    "healthy - здоровый",
    "heap - куча",
    ...
    "henrietta - Генриетта (TR!)",
    "her - ее, ей",
    "herd - стадо",
    "here - здесь, вот",
    "hereafter - После этого(в будущем) (не afterward) (TR!)",
    ...
    "honeycomb - соты",
    "honor - Честь (TR!)",
    "honorable - Благородный (TR!)",
    "honorary - почетный",
    "honour - честь",
    "honourable - почетный, почтенный, честный",
    "honoured - Чтимый(удостоенный) (TR!)",
    "hood - капюшон, капор, колпак, крышка (тех.)",
    "hoof - копыто",
    "hook - крючок",
    "hooker - Проститутка (TR!)",
    "hookup - Соединение (TR!)",
    "hoop - обруч",
    "hooter - Гудок (не buzzer) (TR!)",
    "hop - хмель (бот.)",
    "hope - надеяться",
    ...
    "hopes - Надежды (TR!)",
    "hopped - Прыгал (не sprang, leaped, jumped) (TR!)",
    "hopper - Бункер (TR!)",
    "horace - Хорас (TR!)",
    "horizon - горизонт",
    "horizontal - горизонтальный",
    "horizontally - Горизонтально (TR!)",
    "horn - рог, забодать",
    "horns - Рожки (TR!)",
    "horrible - ужасный h-",
    ...
    "identifier - Идентификатор (TR!)",
    "identifiers - Идентификаторы (TR!)",
    ...
    "illness - болезнь",
    "illuminate - освещать",
    "illuminated - Освещенный (TR!)",
    "illumination - освещение",
    "illusion - иллюзия",
    "illustration - Иллюстрация (TR!)",
    ...
    "imperial - Имперский (TR!)",
    "impertinence - дерзость",
    "implement - выполнять",
    "implementation - Выполнение (TR!)",
    "implemented - Осуществленный (TR!)",
    ...
    "improvements - Усовершенствования (TR!)",
    ...
    "indexes - Индексы (TR!)",
    "indians - Индусы(индейцы) (TR!)",
    "indicate - показывать, указывать",
    "indices - Индексы (не indexes) (TR!)",
    ...
    "indoors - в помещении",
    "induce - убеждать",
    "induced - Вынужденный(вызванный) (TR!)",
    ...
    "inflected - Склоняемый (TR!)",
    "inflection - Сгибание (TR!)",
    ...
    "inspired - Вдохновленный (TR!)",
    "install - водворять, устраивать, устанавливать",
    "installation - Установка (TR!)",
    "installed - Установленный (TR!)",
    "installer - Монтажник (TR!)",
    "installing - Монтаж -ing (TR!)",
    "installs - Устанавливает (TR!)",
    "instance - пример",
    "instances - Случаи *n- (TR!)",
    "instant - мгновение",
    ...
    "intentions - Намерения (TR!)",
    "intently - внимательно !NEW!",
    "interbase - Межоснова (TR!)",
    ...
    "interface - Интерфейс (TR!)",
    "interfere - мешать",
    "interference - вмешательство",
    "interfering - Вмешательство -ing (TR!)",
    "interior - внутренний (не internal)",
    "intermediate - Промежуточное звено (TR!)",
    "internal - внутренний",
    "international - международный",
    "interposed - Вставленный (TR!)",
    ...
    "is - есть (от be)",
    "isabella - Изабелла (TR!)",
    "island - остров",
    "isle - остров(ок)",
    "iso - Международная организация по стандартизации (TR!)",
    "isobel - Исобел (TR!)",
    "isolation - изоляция",
    "issue - выпуск, издание, выпускать",
    "issued - Выпущенный (TR!)",
    "issues - Проблемы(выпуски) (TR!)",
    "it - это, он, она (для предметов и животных)",
    "italian - Итальянец (TR!)",
    "italy - Италия (TR!)",
    "item - вещь, предмет",
    "its - его, ее (от it)",
    "itself - себя, себе",
    ...
    "jealous - ревнивый",
    "jealousy - ревность",
    "jean - Хлопчатобумажная ткань (TR!)",
    "jeanne - Джин (TR!)",
    "jeans - джинсы",
    "jeer - насмешка *e-",
    "jeff - Джеф (TR!)",
    ...
    "jonas - Джонас (TR!)",
    "joseph - Джозеф (TR!)",
    "josephine - Джозефина (TR!)",
    "josie - Джоси (TR!)",
    "journal - журнал j-",
    "journey - путешествие",
    "joy - радость",
    "joyful - радостный, довольный",
    "joyfully - Радостно *o- (TR!)",
    "judge - судья",
    "judged - Оцененный *u- (не valued) (TR!)",
    "judgement - приговор, суждение",
    "judgment - Суждение (TR!)",
    "jug - кувшин",
    "juice - сок",
    ...
    "knob - knob - НЕВЫУЧЕННОЕ СЛОВО (TR!)",
    "knock - стучать, стук",
    ...
    "laden - Груженый, нагруженный, обремененный (TR!)",
    "ladies - дамы (от lady)",
    ...
    "leads - Лидерство (TR!)",
    "leaf - лист",
    "leaflet - Рекламный листок (TR!)",
    "leaflets - Рекламные листки (TR!)",
    "league - союз, лига",
    "leak - просачиваться",
    "lean - прислоняться, наклоняться, наклон",
    "leap - високосный, прыжок, прыгать",
    "leaped - Прыгал (не sprang, jumped, hopped) (TR!)",
    "leapt - прыгал !NEW!",
    ...
    "located - Расположенный (TR!)",
    "location - местоположение",
    "locations - Местоположения (TR!)",
    "lock - замок, запирать на замок",
    "locked - запертый l-",
    "locking - Захват -ing (TR!)",
    "locks - Замки (TR!)",
    "locksmith - слесарь",
    "lodge - разместить",
    ...
    "lovers - Любители(возлюбленные) (TR!)",
    "loving - любящий",
    "low - низкий",
    "lower - нижний, снижать, опускать",
    "lowered - Пониженный (TR!)",
    ...
    "maintained - Обслуженный(поддержанный) (TR!)",
    ...
    "marched - Прошел (TR!)",
    "marco - Марко (TR!)",
    "margaret - Маргарет (TR!)",
    "margarita - Маргарита (TR!)",
    ...
    "marrying - Бракосочетание -ing (TR!)",
    "marsh - болото m-",
    "martial - военный",
    ...
    "mat - коврик (не rug)",
    "match - спичка, матч",
    "matches - Сделки, спички (TR!)",
    "mate - товарищ",
    "material - материал",
    "materials - Материалы (TR!)",
    ...
    "millet - просо, пшено",
    "million - миллион",
    "millions - Миллионы (TR!)",
    "mind - память, мнение, помнить, возражать",
    "minded - Склонный (TR!)",
    "minds - ум !NEW!",
    "mine - мой (употребляется без последующего существительного)",
    "mineral - минeральный",
    "mingled - Смешанный (TR!)",
    "miniaturization - Миниатюризация (TR!)",
    "minims - Мельчайшая частица, очень маленькая доля, капля (TR!)",
    "minimum - минимум",
    "mining - горный -ing",
    "minister - министр",
    ...
    "model - модель",
    "moderate - умеренный",
    "moderately - Умеренно (TR!)",
    "modern - современный",
    "modest - скромный m-",
    "modification - Модификация (TR!)",
    ...
    "mutter - бормотать",
    "muttered - Бормотал (TR!)",
    "muttering - Бормотание -ing (TR!)",
    "mutton - баранина",
    ...
    "nations - Нации (TR!)",
    "native - родной",
    "natives - Аборигены (TR!)",
    "natural - естественный",
    "naturalist - Натуралист (TR!)",
    "naturalists - Натуралисты (TR!)",
    ...
    "nobleman - дворянин",
    "nobles - Знать (знатные люди) (TR!)",
    "nobody - никто",
    "nod - кивать головой, кивок",
    "nodding - Кивающий (TR!)",
    "node - Узел (не knot) (TR!)",
    "noise - шум",
    "noiseless - бесшумный",
    "noises - Шумы (TR!)",
    "noisy - шумный",
    ...
    "nuisance - досада",
    "null - Пустой указатель (TR!)",
    "nulls - Пустые указатели (TR!)",
    "numb - онемелый, оцепенелый (не dumb, )",
    "number - номер",
    "numbers - Номера(числа) (TR!)",
    ...
    "parted - Разделенный (TR!)",
    "partial - частичный",
    "partially - Частично (TR!)",
    "participate - участвовать",
    "particles - Частицы (TR!)",
    "particular - особый",
    ...
    "paths - Дорожки (не roads, lanes) (TR!)",
    "patience - терпение",
    "patient - пациент, терпеливый",
    "patiently - Терпеливо (TR!)",
    "patrol - патруль",
    "patsy - Паци (TR!)",
    "patted - Ласкал (TR!)",
    "pattern - модель",
    ...
    "performed - Выполненный (не от слова fulfil) (TR!)",
    "perfume - духи",
    ...
    "persuade - убеждать",
    "persuaded - Убежденный (не convinced) (TR!)",
    ...
    "pizza - пицца",
    "place - место",
    "placing - Размещение -ing (TR!)",
    "plain - ясный, очевидный, равнина",
    "plainly - Явно (не clearly, obvious) (TR!)",
    "plains - Равнины (TR!)",
    ...
    "points - Пункты(точки) (TR!)",
    "poison - яд, отравлять",
    "poisonous - ядовитый",
    "poke - толчок, тыкать",
    "poking - Тыкание -ing (TR!)",
    "polar - полярный",
    "pole - полюс",
    "police - полиция",
    ...
    "port - порт",
    "portable - переносной",
    "ported - Перенесенный, транспортированный (TR!)",
    "porter - носильщик",
    ...
    "prevailed - Преобладал (TR!)",
    "prevent - предотвращать, препятствовать",
    "prevented - Предотвращенный (TR!)",
    ...
    "prince - принц",
    "princess - Принцесса (TR!)",
    "principal - главный, основной, важнейший p-",
    "principle - принцип",
    "principles - Принципы (TR!)",
    ...
    "pursued - Преследуемый (TR!)",
    "pursuing - Преследование -ing (TR!)",
    "pursuit - преследование, погоня, занятие",
    "push - толкать",
    "pushed - вытолкнутый !NEW!",
    "pushing - Подталкивание(выдвижение) -ing (TR!)",
    ...
    "referred - Отнесенный (TR!)",
    "refers - Обращается(относится) (TR!)",
    "reflect - отражать, размышлять",
    "reflected - Отраженный (TR!)",
    "reflecting - отражающий",
    "reflection - отражение, размышление",
    "reflections - Отражения (TR!)",
    ...
    "renamed - Переименованный (TR!)",
    "render - отдавать",
    "rendered - Предоставленный (не supplied) (TR!)",
    "renew - обновлять",
    "renewal - обновление (не refresh)",
    "renewed - Возобновленный (не resumed) (TR!)",
    ...
    "rollback - Обратная перемотка (TR!)",
    "roller - ролик",
    "roman - Католик (TR!)",
    ...
    "scattered - Разбросанный, раскиданный (TR!)",
    ...
    "scoundrel - негодяй",
    "scout - разведчик",
    "scowled - Хмурился (не от слова frown) (TR!)",
    "scramble - карабкаться",
    "scrambled - Боролся(взбирался) (TR!)",
    "scrap - клочок, кусочек, отрывок",
    "scratch - царапать",
    "scratched - Поцарапанный (TR!)",
    ...
    "script - сценарий",
    "scripts - Подлинники(сценарии) (TR!)",
    "scrub - тереть",
    "scuba - Акваланг (TR!)",
    ...
    "seated - Помещенный (TR!)",
    "seats - места (от seat)",
    "seaweed - Морская водоросль (TR!)",
    "second - второй, помощник, секунда",
    "secondary - средний, второстепенный",
    "secondly - Во-вторых (TR!)",
    "secret - секрет",
    "secretary - секретарь",
    "secretion - Укрывательство (TR!)",
    ...
    "sensitiveness - Чувствительность (TR!)",
    "sent - отправил, послал, отправленный, посланный (от send)",
    "sentence - предложение s-",
    "sentiment - настроение",
    "sentiments - Чувства (TR!)",
    "separate - отдельный",
    "separated - Отделенный (TR!)",
    ...
    "since - с тех пор как",
    "sincere - искренний (-e)",
    "sincerely - Искренне (не earnestly) (TR!)",
    "sing - пение, петь",
    "singing - Пение (TR!)",
    ...
    "sniffed - Фыркал (TR!)",
    "sniffing - Фыркающий (TR!)",
    "snigger - хихикать, хихиканье s-",
    "snoop - подсматривать !NEW!",
    "snore - храпеть, храп",
    "snorted - Фыркал (не от слова sniff) (TR!)",
    ...
    "soften - смягчать(ся)",
    "softened - Смягченный (TR!)",
    "softly - мягко, нежно",
    "software - Программное обеспечение (TR!)",
    "soil - почва",
    "sold - продавал, проданный (от sell)",
    "solder - паять",
    "soldier - солдат",
    "sole - подошва, подметка; ставить подметку",
    "solely - Исключительно (TR!)",
    ...
    "sorting - Сортировка (TR!)",
    "sought - Искавший(разысканный) (TR!)",
    ...
    "spared - Сэкономленный (TR!)",
    "spark - искра",
    "sparkle - сверкать, искриться",
    "sparkler - Бриллиант (TR!)",
    "sparrow - воробей",
    ...
    "specification - Спецификация (TR!)",
    "specified - Указанный (TR!)",
    "specify - точно определять, устанавливать, предписывать; детально излагать",
    "specimen - образец",
    "specimens - Экземпляры, образцы (TR!)",
    "spectacle - зрелище",
    "spectacles - очки",
    ...
    "spots - Пятна(места) (TR!)",
    "spotted - Определенный *p- (TR!)",
    "spout - носик (посуды), желоб",
    "sprang - Прыгал (от слова spring) (TR!)",
    "spray - брызги, обрызгивать",
    "spread - распространяться",
    "spreading - Распространение -ing (TR!)",
    "spree - веселье, шалость *p-",
    "spring - весна",
    "sprout - пускать ростки; отросток, побег",
    "spruce - Ель (TR!)",
    "sprung - Прыгал (от слова spring) (TR!)",
    "spur - стимул",
    ...
    "stated - зафиксированный, высказанный, изложенный Заявленный (TR!)",
    "stately - величавый, величественный",
    "statement - утверждение, заявление",
    "statements - Утверждения(заявления) (TR!)",
    "states - Государства (TR!)",
    ...
    "stuffed - Наполненный (TR!)",
    "stuffy - душный",
    "stumbled - Наткнулся (TR!)",
    "stump - пень",
    "stun - оглушать",
    "stupid - глупый",
    ...
    "subjected - Подвергнутый *u- (TR!)",
    "subjects - предметы (от subject)",
    "submarine - подводная лодка",
    "submit - подчиняться",
    "subqueries - Подвопросы (TR!)",
    "subquery - Подвопрос (TR!)",
    ...
    "superserver - Суперприслуга (TR!)",
    "superstition - суеверие, предрассудки",
    "supper - ужин",
    "supplement - добавление",
    "supplied - Снабженный (TR!)",
    "supplies - Запасы(поставки) (TR!)",
    "supply - снабжать",
    "support - поддерживать, опора, поддержка",
    "supported - Поддержанный (TR!)",
    "supporter - сторонник",
    ...
    "travels - Путешествия (TR!)",
    "traverse - пересекать",
    "tray - поднос",
    "treacherous - предательский, вероломный",
    "tread - ступать, наступать",
    "treasure - сокровище",
    "treasurer - Казначей (TR!)",
    "treasures - Сокровища (TR!)",
    ...
    "trifle - пустяк",
    "trifling - Пустяковый -ing (TR!)",
    "trigger - курок",
    "triggers - Спусковые механизмы (TR!)",
    ...
    "tube - труба (не pipe)",
    "tucked - Подвернутый (TR!)",
    "Tuesday - вторник",
    "tumble - падать, опрокидываться",
    "tumbled - Кувыркался (TR!)",
    "tumbler - Тумблер (TR!)",
    "tune - мотив",
    "tunnel - тоннель",
    "turf - дерн",
    ...
    "ugly - уродливый",
    "ultimate - последний",
    "ultimately - В конечном счете (TR!)",
    "umbrella - зонт",
    "un - ООН (TR!)",
    "unable - неспособный",
    ...
    "unregistered - Незарегистрированный (TR!)",
    ...
    "update - Модернизация (TR!)",
    "updated - Обновленный (TR!)",
    "upgrade - Модернизировать (TR!)",
    "upon - на",
    "upper - верхний",
    ...
    "urban - городской",
    "urge - понуждать",
    "urged - Побуждённый, подстёгнутый (TR!)",
    ...
    "vanity - тщеславие",
    "vapour - пар, пары",
    "variability - Изменчивость (TR!)",
    "variable - изменчивый, непостоянный",
    "variables - Переменные (TR!)",
    "variation - Изменение(разновидность) (TR!)",
    "variations - Изменения(разновидности) (TR!)",
    "varied - Различный (не differ) (TR!)",
    "varieties - Множества (TR!)",
    "variety - разнообразие",
    "various - различный, разный",
    "varnish - лак, лоск, лакировать",
    "vary - отличаться, расходиться",
    "varying - Изменение -ing (TR!)",
    "vase - ваза",
    ...
    "viewed - Рассматриваемый (TR!)",
    "viewpoint - точка зрения",
    "views - Представления(виды) (TR!)",
    ...
    "waggoner - Извозчик (TR!)",
    "wagon - повозка !NEW!",
    "wail - вопль, вой, вопить, выть",
    "wailed - Вопил (TR!)",
    "wailing - Вопящий -ing (TR!)",
    "waist - талия",
    "waistcoat - жилет",
    ...
    "waving - Помахивание (TR!)",
    "wavy - волнистый, бурный",
    "wax - воск, восковой",
    "waxworks - Восковые фигуры (TR!)",
    ...
    "without - без",
    "witness - свидетель",
    "witnessed - Засвидетельствованный (TR!)",
    "wits - Остроумие (TR!)",
    "wizard - колдун, специалист своего дела !NEW!",
    "wizards - Волшебники (TR!)",
    "woke - будил (от wake)",
    ...
    "woodlands - Лесистые местности (TR!)",
    "wool - шерсть",
    "woollen - шерстяной",
    "word - слово, обещание",
    ...
    "yield - приносить y-",
    "yielded - Выданный (TR!)",
    "yielding - Выдающий(уступающий) -ing (TR!)",
    "yoke - иго, ярмо",
    "yonder - вон тот !NEW!",
    "you - вы, ты",
    "young - молодой",
